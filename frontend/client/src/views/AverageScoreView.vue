...
<div class="flex justify-center">
  <form @submit.prevent="onSubmit" >   
    ...
    <div class="relative">
      ...
      <input id="movies" class="block pr-20  p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50  bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-green-500 focus:border-green-500" placeholder="Movies" required v-model="movies">
